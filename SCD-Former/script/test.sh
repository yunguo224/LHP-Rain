...
### test on GoPro ###
# python test/test_gopro_hide.py --input_dir /mnt/data/yeyuntong/Projects/Datasets/SPA/test/input/ --result_dir /mnt/data/yeyuntong/Projects/Transformer/Uformer/results/Ours2SPA/ --weights /mnt/data/yeyuntong/Projects/Transformer/Uformer/logs/motiondeblur/GoPro/Uformer_B_0301_13k/models/model_latest.pth
