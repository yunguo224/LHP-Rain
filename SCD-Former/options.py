...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--pretrain_weights',type=str, default='/mnt/data/yeyuntong/Projects/Transformer/Uformer/logs/motiondeblur/GoPro/Uformer_B_Ours/models/model_latest.pth', help='path of pretrained_weights')
